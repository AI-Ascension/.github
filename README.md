...
| Path | Purpose |
| --- | --- |
| `profile/README.md` | The organization profile: hero, status line, proof link, four audience paths, the ascent table, evidence labels, disclaimer. |
...
| [`CODEOWNERS`](CODEOWNERS) | Review ownership for this repository. |

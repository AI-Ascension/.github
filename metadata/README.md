...
The registry preserves the 12 historically public repository entries. The [2026-09-17 refresh](audits/2026-09-17/README.md) selects 11 currently public targets and advances their source pins to the verified default-branch heads; one historical entry is marked unmanaged after visibility drift, preserving its old evidence. Four first-party repositories created after the 2026-09-08 refresh are recorded with `managed: false` pending an owner applicability decision, and two private discoveries are held out pending the same decision; their identities and all fresh private evidence remain outside this publication. The `AI-Ascension/.github` row asserts no `default_commit`, because a registry stored inside that repository cannot record the head of the branch that contains it. See also the [2026-09-08 review](audits/2026-09-08/README.md). Pinned public-source manifests remain reproducible
